                            ...
                            <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                                <iframe
                                    src={process.env.NODE_ENV === 'production'
                                        ? `http://localhost:1430/youtube-player.html?id=${id}`
                                        : `https://www.youtube-nocookie.com/embed/${id}?autoplay=1&origin=${typeof window !== 'undefined' ? window.location.origin : 'http://localhost:3000'}`}
